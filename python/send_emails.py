...
def create_email(user_id, email, firstname, lastname):
    ...
    text += "Non jusqu'à la fin de la semaine: "+urlno+"&validity=next_monday\n"
    text += "\n"
    ...
    html += "<p>"
    html += "<a href='"+urlyes+"&validity=next_monday'>Oui jusqu'à la fin de la semaine</a>\n"
    html += "<br/>"
    html += "<a href='"+urlno+"&validity=next_monday'>Non jusqu'à la fin de la semaine</a>\n"
    html += "</p>"
    html += "<p>"
